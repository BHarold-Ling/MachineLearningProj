...
The training process selected `r mtry.sel` variables at each branch as the best parameter, and has estimated an accuracy of `r acc1` for new data.
...
This shows a training accuracy of `r round(tr.acc, 4)`, which is a little higher than the predicted testing accuracy, as we would expect.
